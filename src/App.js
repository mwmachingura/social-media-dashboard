  ...
  return (
    <div className="App">
      <div className='py-8 px-4 bg-white'>
        ...
        <div className='grid grid-cols-1 gap-y-4 auto-rows-max justify-items-center py-4'>
          <div className='facebook bg-cardbackground shadow-sm flex flex-col w-full rounded-lg items-center overflow-hidden'>
            ...
            <h1 className='font-bold pt-3 pb-1 text-6xl text-dark-text'>1987</h1>
            <h3 className='font-normal pt-1 pb-2 text-sm uppercase text-text tracking-large'>FOLLOWERS</h3>
          ...
          <div className='twitter bg-cardbackground shadow-sm flex flex-col w-full rounded-lg items-center overflow-hidden'>
            ...
            <h1 className='font-bold pt-3 pb-1 text-6xl text-dark-text'>1044</h1>
            <h3 className='font-normal pt-1 pb-2 text-sm uppercase text-text tracking-large'>FOLLOWERS</h3>
            <p className='flex justify-evenly items-center font-bold text-limegreen text-sm py-4'>
              <span className='mx-1'>
              <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fillrule="evenodd" d="M0 4l4-4 4 4z"/></svg>
          ...
          <div className='instagram bg-topbackground shadow-sm flex flex-col w-full rounded-lg items-center overflow-hidden'>
            ...
            <h1 className='font-bold pt-3 pb-1 text-6xl text-dark-text'>11k</h1>
            <h3 className='font-normal pt-1 pb-2 text-sm uppercase text-text tracking-large'>FOLLOWERS</h3>
          ...
          <div className='youtube bg-cardbackground shadow-sm flex flex-col w-full rounded-lg items-center overflow-hidden'>
            ...
            <h1 className='font-bold pt-3 pb-1 text-6xl text-dark-text'>8239</h1>
            <h3 className='font-normal pt-1 pb-2 text-sm uppercase text-text tracking-large'>SUBSCRIBERS</h3>
        ...
        <div className='overview-section'>
          ...
          <div className='overview'>
            <div className='overview-content'>
              <h3 className=''>Page Views
                <span>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"><path fill="#178FF5" d="M18.896 0H1.104C.494 0 0 .494 0 1.104v17.793C0 19.506.494 20 1.104 20h9.58v-7.745H8.076V9.237h2.606V7.01c0-2.583 1.578-3.99 3.883-3.99 1.104 0 2.052.082 2.329.119v2.7h-1.598c-1.254 0-1.496.597-1.496 1.47v1.928h2.989l-.39 3.018h-2.6V20h5.098c.608 0 1.102-.494 1.102-1.104V1.104C20 .494 19.506 0 18.896 0z"/></svg>
                </span>
              </h3>
              <h1>87</h1>
              <span><svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fill-rule="evenodd" d="M0 4l4-4 4 4z"/></svg></span>3%
            </div>
          </div>
        </div>
      </div>
